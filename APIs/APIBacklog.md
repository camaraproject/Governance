...
| -----------------------| --------- | ------------ | -------- |----------------------------------------------------|---------------------------|---------------------------------|-------------|
| Quality on demand || DT + TELUS | <ul><li>It provides the customer with the ability to set quality for a mobile connection (e.g. required latency, jitter, bit rate)</li><li>Get notification if network cannot fulfill/</li><ul><p>*NOTE: The scope of this API family should be limited (at least at a first stage) to 4G and 5G | ||||
