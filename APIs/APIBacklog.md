...
| -----------------------| --------- | ------------ | -------- |----------------------------------------------------|---------------------------|---------------------------------|-------------|
| Quality on demand || DT + TELUS | <p> * It provides the customer with the ability to set quality for a mobile connection (e.g. required latency, jitter, bit rate).<br> * Get notification if network cannot fulfill. <br> * __NOTE: The scope of this API family should be limited (at least at a first stage) to 4G and 5G__ </p> | | |||
